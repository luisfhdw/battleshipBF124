...
public class EventTest {
    ...
    static {
        try {
            PLACEMENT = new ShipPlacement(ShipType.BATTLESHIP, new Coordinate(0, 0), Direction.SOUTH, Player.FIRST);
            Thread.sleep(1);
            PLACEMENT2 = new ShipPlacement(ShipType.BATTLESHIP, new Coordinate(0, 0), Direction.SOUTH, Player.FIRST);
            Thread.sleep(1);
